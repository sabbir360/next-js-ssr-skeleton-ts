...
function setPageTitle(value: String) : String{
	return `About | ${value}`
}

export const getServerSideProps: GetServerSideProps = async (context) => {
	var data: AboutResponse = { Name: "Mark", Age: "32" }
	return {props:{data}}
};


export default function About({data}: {data:AboutResponse}) {
	return (
		<>
			<Head>
				<title>{setPageTitle(data.Name)}</title>
				<meta
					name="description"
